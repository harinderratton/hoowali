                        ...
                        <div class="row">
                              <div class="col-lg-6">
                                  ...
                                  <div class="table-data__tool-right">
                                    <a href="{{route('admin.news_list')}}"> <button class="au-btn au-btn-icon au-btn--green au-btn--small">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body card-block">
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="textarea-input" class=" form-control-label">News Description</label>
                                                </div>
                                                <div class="col-12 col-md-9">
